...
/usr/bin/wget http://ims-chef.wesleyan.edu/cmdr/chef_11.4.2-1.ubuntu.11.04_amd64.deb
...
wget http://ims-chef.wesleyan.edu/cmdr/validation.pem
mv validation.pem /etc/chef/validation.pem
wget http://ims-chef.wesleyan.edu/cmdr/roles.json
mv roles.json /etc/chef/roles.json
wget http://ims-chef.wesleyan.edu/cmdr/client.rb
